...
\pinyinge[zá|xìng][杂兴]
\pinyinge[sù|shè][宿舍]
\pinyinge[qīng|tíng][蜻蜓]
\pinyinge[xī|shǎo][稀少]

\pinyinge[jī|lóng][鸡笼]
\pinyinge[yī|lài][依赖]
\pinyinge[máo|yán][茅檐]
\pinyinge[lǎo|wēng][老翁]
...
\startcolumns[n=4,separator=off]
\kuohaozu{%
    帐\answerB{帐篷}\\账\answerB{结账}}
\kuohaozu{%
    摊\answerB{摆摊}\\滩\answerB{沙滩}}
\kuohaozu{%
    蝠\answerB{蝙蝠}\\福\answerB{福气}}
\kuohaozu{%
    蝙\answerB{蝙蝠}\\编\answerB{编织}}
\stopcolumns
