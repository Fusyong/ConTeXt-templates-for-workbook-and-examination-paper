...
\scale[scale=2500]{%
\startpositioning
\position(0.6,0.24){\blackrule[color=lightProofColor,width=0.72cm,height=1.1cm]}
\position(0.28,0.42){\blackrule[color=lightAboveColor, width=0.34cm,height=0.78cm]}
...
\scale[s=2.5]{%
\startpositioning
\position(0.18,0.4){\blackrule[color=lightAboveColor, width=0.34cm,height=0.44cm]}
\position(0,0.8){\blackrule[color=lightProofColor,width=1.5cm,height=0.04cm]}
\position(0,1){\blackrule[color=lightAboveColor,width=1.5cm,height=0.04cm]}
\position(0.9,1){\blackrule[color=lightProofColor,width=0.15cm,height=0.36cm]}
